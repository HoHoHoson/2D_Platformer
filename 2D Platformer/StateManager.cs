...
namespace _2D_Platformer
{
	...
	public static class StateManager
    {
		...
		static public int GameStatesCount
        {
            get
            {
                return dGameStates.Count;
            }
        }
		static public String GameStateNames
        {
            get
            {
				String s = "";
		...
		static public int StateStackCount
        {
            get
            {
                return lStateStack.Count;
            }
        }
		static public String StateStackCurrent
        {
            get
            {
                return sCurrent;
